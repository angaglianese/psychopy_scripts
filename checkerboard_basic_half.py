...
This experiment was created using PsychoPy3 Experiment Builder (v2020.1.3),
    on May 24, 2022, at 13:34 by Anna Gaglianese
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\lifmet_fmri_A\\Desktop\\AnnaGaglianese\\2020_08_04_PsychoPy_boxcar\\checkerboard_basic.py',
...
for thisTrial in trials:
    ...
    wedge2 = visual.RadialStim(win, tex='sqrXsqr', color=-1, size=60, pos=[0, move_centre_up_by],
        visibleWedge=[10, 170], radialCycles=4, angularCycles=8, interpolate=False,
        autoLog=False)     # this stim changes too much for autologging to be useful
    wedge3 = visual.RadialStim(win, tex='sqrXsqr', color=1,  size=60, pos=[0, move_centre_up_by],
        visibleWedge=[190, 350], radialCycles=4, angularCycles=8, interpolate=False,
        autoLog=False)     # this stim changes too much for autologging to be useful
    wedge4 = visual.RadialStim(win, tex='sqrXsqr', color=-1, size=60, pos=[0, move_centre_up_by],
        visibleWedge=[190, 350], radialCycles=4, angularCycles=8, interpolate=False,
        autoLog=False)     # this stim changes too much for autologging to be useful
    ...
    trials_rn = np.random.randint(1,3)
    if trials_rn == 1:    
